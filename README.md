# Aave_brownie_py
This is a blockchain project based on an Open Source Liquidity Protocol called AAve where we earn interest, borrow assets, and build applications related to digital assets
...
1. [Get some goerli ETH](https://faucet.goerli.network/)
